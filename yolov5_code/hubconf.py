...
if __name__ == '__main__':
    model = _create(name='yolov5x', pretrained=True, channels=3, classes=80, autoshape=True, verbose=True)  # pretrained
    # model = custom(path='path/to/model.pt')  # custom
    # model = custom(path='/Users/seok/Desktop/CP1/django_yolo_api/yolov5_code/best.pt')  # custom
    # model = custom(path='/Users/seok/Desktop/CP1/django_yolo_api/yolov5_code/best.pt')  # custom
