...
def accident(request):
    if request.method == 'GET' :
        ...
        if accident_type == str(1) :
            ...
            step1 = ' ※ 사고 당시상황 및 사고 현장을 사진을 찍어주세요. (추후 과실비율 산정시 사용될 수 있습니다.)'
            step2 = ''' 1. 전동킥보드 등의 운전으로 인해 사람을 사상하거나 물건을 손괴(이하 “교통사고”라 함)한 경우에는 전동킥보드 등의 운전자는 즉시 정차하여 다음의 조치를 해야 합니다. (「도로교통법」제54조제1항).','\n',
                ' - 사상자를 구호하는 등 필요한 조치','\n',
            ...
            step3 = ' ※ 해당 조취를 취한 뒤 고객센터로 접수하세요.'
            
            context = {'step1':step1, 'step2':step2, 'step3':step3}
            return render(request, 'main/accident.html', context)
